...
That's basically an alias of the above `.add` method. Both methods first check if the rules exists and if yes then internally calls the [`update`](#ruleupdateselector-new-styles) method of the [CSSX rule object](#rule-api).
